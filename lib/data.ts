...
export const blogPosts = [
  {
    ...
    excerpt: "Build a capsule wardrobe with these essential pieces that never go out of style. From the perfect white button-down to classic ballet flats.",
  ...
  },
  {
    ...
    excerpt: "Transform any corner into your personal sanctuary with plush textures, warm lighting, and thoughtful design elements.",
  ...
  },
  {
    ...
    excerpt: "A step-by-step guide to the products and techniques that transformed my complexion. Plus my holy grail products.",
  ...
  },
  {
    ...
    excerpt: "Fresh spring styling inspiration featuring trending colors, textures, and silhouettes you'll want to recreate.",
  ...
  },
  {
    ...
    excerpt: "How I prepare for the week ahead with intentional practices for mind, body, and soul. Your guide to a restorative Sunday.",
  ...
  },
  {
    ...
    excerpt: "How I transformed my living space with affordable finds and clever styling tricks. Before and after included!",
  ...
  },
  {
    ...
    excerpt: "Effortless, chic, and timeless—learn the secrets behind that coveted Parisian aesthetic and how to achieve it.",
  ...
  },
  {
    ...
    excerpt: "My curated selection of non-toxic, sustainable beauty products that actually deliver results.",
...
export const amazonFinds = [
  ...
  },
  {
    ...
    price: "$32.99",
    originalPrice: "$42.99",
    image: "https://images.unsplash.com/photo-1612620743150-fcea8ec5442a?w=800&q=80",
    link: "https://amazon.com",
    category: "Home",
  },
  {
    ...
    price: "$14.99",
    image: "https://images.unsplash.com/photo-1522338242042-2d1c22ed1641?w=800&q=80",
    link: "https://amazon.com",
    category: "Beauty",
  },
  {
    id: 5,
    title: "Linen Blend Wide Leg Pants - Effortlessly Chic",
    price: "$38.99",
    originalPrice: "$49.99",
  ...
  {
    id: 6,
    title: "Aromatherapy Candle Set - Lavender & Vanilla",
    price: "$24.99",
    image: "https://images.unsplash.com/photo-1602028279672-27e2e459f830?w=800&q=80",
    link: "https://amazon.com",
    category: "Home",
  },
  {
    id: 7,
    title: "Oversized Cashmere-Feel Scarf",
    price: "$28.99",
